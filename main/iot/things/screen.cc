...
public:
    Screen() : Thing("Screen", "这是一个屏幕，可设置主题，亮度，样式等") {
        // 定义设备的主题属性
        ...
        // 定义设备的样式属性
        properties_.AddStringProperty("style", "样式", [this]() -> std::string {
        ...
        methods_.AddMethod("SetStyle", "设置屏幕样式", ParameterList({
            Parameter("theme_style", "主题样式,normal 或 wechat 或 animation", kValueTypeString, true)
        }), [this](const ParameterList& parameters) {
